...
count(Data$SR)
Data <- Data %>%  mutate(SR = recode(SR, "1" = 0, "2" = 0, "3" = 0, "4" = 1, "5" = 1, "6" = 1, "7"= 1))
count(Data$SR)
...
lm_DF <- lm_DF %>% dplyr::rename(TS = "T",  FR= "Rank", E = "EXT", PR = "AR")
