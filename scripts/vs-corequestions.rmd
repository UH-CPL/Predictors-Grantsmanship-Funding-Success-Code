...
South = 'Florida|Georgia|Tennessee|Texas|Virginia|Alabama|^North Carolina$|^oklahoma$'
...
# for (i in 2:3) {
  ...
  for (row_num in 1:nrow(temp2)){
    print("Hello")
    x_lebel = paste(x_lebel, temp2$Item[row_num], "\t\t\t\t\t\tLCI =", temp2$LCI[row_num], "\t\t\t\t\t\tUCI =", temp2$UCI[row_num], "\n")
  }
  
    # x_lebel = head(temp2, length(temp2))
    # paste0(
    # "\n\n\n",
    
    # print(temp2, quote = TRUE, row.names = FALSE)
    # "Item = ",
    # temp2$Item,
    # ",     ",
    # "LCI = ",
